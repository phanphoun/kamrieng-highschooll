...
{
    /**
     * Roles that may be chosen at public registration.
     * Students, teachers and parents are created by admins (US-04).
     */
    public const ALLOWED_ROLES = ['admin', 'content_editor'];
