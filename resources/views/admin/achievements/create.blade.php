...
@section('title', __('admin.create_achievement'))

@section('content')
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-gray-900">{{ __('admin.create_achievement') }}</h1>
        <p class="text-gray-600 mt-1">{{ __('admin.create_achievement_description') }}</p>
    </div>
        ...
        <form action="{{ route('admin.achievements.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="achieved_by" name="achieved_by" value="{{ old('achieved_by') }}"
                           class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">
                ...
                <div>
                    ...
                    <input type="date" id="achieved_date" name="achieved_date" value="{{ old('achieved_date') }}"
                           class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">
