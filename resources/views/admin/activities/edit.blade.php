...
@section('title', __('admin.edit_activity'))

@section('content')
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-gray-900">{{ __('admin.edit_activity') }}</h1>
        <p class="text-gray-600 mt-1">{{ __('admin.edit_activity_description') }}</p>
    </div>
        ...
        <form action="{{ route('admin.activities.update', $activity) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" id="title_en" name="title_en" value="{{ old('title_en', $activity->title_en) }}" required
                ...
                <div>
                    ...
                    <input type="text" id="title_kh" name="title_kh" value="{{ old('title_kh', $activity->title_kh) }}"
                           class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">
                ...
                <div>
                    ...
                    @if($activity->featured_image)
                        <div class="mb-2">
                            <img src="{{ asset('storage/' . $activity->featured_image) }}" alt="{{ $activity->title_en }}" class="h-20 w-20 object-cover rounded-lg">
                        </div>
                    @endif
            ...
            <div class="mt-6">
                ...
                <textarea id="description_en" name="description_en" rows="4"
                          class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">{{ old('description_en', $activity->description_en) }}</textarea>
            ...
            <div class="mt-6">
                ...
                <textarea id="description_kh" name="description_kh" rows="4"
                          class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">{{ old('description_kh', $activity->description_kh) }}</textarea>
            ...
            <div class="mt-6">
                ...
                <textarea id="content_en" name="content_en" rows="8"
                          class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">{{ old('content_en', $activity->content_en) }}</textarea>
            ...
            <div class="mt-6">
                ...
                <textarea id="content_kh" name="content_kh" rows="8"
                          class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">{{ old('content_kh', $activity->content_kh) }}</textarea>
