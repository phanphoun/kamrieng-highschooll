...
@section('content')
    <div class="mb-8">
        <div class="flex items-center gap-4 mb-4">
            ...
            <h1 class="text-2xl font-bold text-gray-900">Create Download</h1>
        </div>
    </div>
        ...
        <form action="{{ route('admin.downloads.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <textarea name="description_en" id="description_en" rows="4" class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">{{ old('description_en') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="description_kh" id="description_kh" rows="4" class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">{{ old('description_kh') }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="text" name="category" id="category" value="{{ old('category') }}" class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">
