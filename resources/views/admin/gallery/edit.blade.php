...
@section('content')
    <div class="mb-6">
        ...
        <p class="text-gray-600 mt-1">Update album details</p>
    </div>
        ...
        <form action="{{ route('admin.gallery.update', $gallery) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="title_en" id="title_en" value="{{ old('title_en', $gallery->title_en) }}"
                ...
                <div>
                    ...
                    <input type="text" name="title_kh" id="title_kh" value="{{ old('title_kh', $gallery->title_kh) }}"
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500">
                ...
                <div>
                    ...
                    <textarea name="description_en" id="description_en" rows="3"
                              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500">{{ old('description_en', $gallery->description_en) }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="description_kh" id="description_kh" rows="3"
                              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500">{{ old('description_kh', $gallery->description_kh) }}</textarea>
                    ...
                    @if($gallery->cover_image)
                        <div class="mt-1 mb-2">
                            <img src="{{ Storage::url($gallery->cover_image) }}"
                                 alt="Current cover" class="w-24 h-24 object-cover rounded-lg">
                        </div>
                    @endif
                ...
                <div>
                    ...
                    <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $gallery->sort_order ?? 0) }}" min="0"
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500">
