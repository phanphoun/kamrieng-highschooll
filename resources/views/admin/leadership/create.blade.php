...
@section('content')
    <div class="mb-8">
        <div class="flex items-center gap-4 mb-4">
            ...
            <h1 class="text-2xl font-bold text-gray-900">Create Leadership Member</h1>
        </div>
    </div>
        ...
        <form action="{{ route('admin.leadership.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="text" name="name_en" id="name_en" value="{{ old('name_en') }}" class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">
                ...
                <div>
                    ...
                    <input type="text" name="name_kh" id="name_kh" value="{{ old('name_kh') }}" class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="text" name="position_en" id="position_en" value="{{ old('position_en') }}" class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">
                ...
                <div>
                    ...
                    <input type="text" name="position_kh" id="position_kh" value="{{ old('position_kh') }}" class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <textarea name="bio_en" id="bio_en" rows="5" class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">{{ old('bio_en') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="bio_kh" id="bio_kh" rows="5" class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">{{ old('bio_kh') }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email') }}" class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">
                    @error('email') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                </div>
                <div>
                    <label for="phone" class="block text-sm font-medium text-gray-700 mb-1">Phone</label>
                    <input type="text" name="phone" id="phone" value="{{ old('phone') }}" class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">
