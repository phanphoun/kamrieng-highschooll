...
@section('content')
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-gray-900">{{ __('admin.edit_news') }}</h1>
        <p class="text-gray-600 mt-1">{{ __('admin.edit_news_description') }}</p>
    </div>
        ...
        <form action="{{ route('admin.news.update', $news) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" id="title_en" name="title_en" value="{{ old('title_en', $news->title_en) }}" required
                ...
                <div>
                    ...
                    <input type="text" id="title_kh" name="title_kh" value="{{ old('title_kh', $news->title_kh) }}"
                           class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">
                ...
                <div>
                    ...
                    @if($news->featured_image)
                        <div class="mb-2">
                            <img src="{{ asset('storage/' . $news->featured_image) }}" alt="{{ $news->title_en }}" class="h-20 w-20 object-cover rounded-lg">
                        </div>
                    @endif
            ...
            <div class="mt-6">
                ...
                <textarea id="excerpt_en" name="excerpt_en" rows="3"
                          class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">{{ old('excerpt_en', $news->excerpt_en) }}</textarea>
            ...
            <div class="mt-6">
                ...
                <textarea id="excerpt_kh" name="excerpt_kh" rows="3"
                          class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">{{ old('excerpt_kh', $news->excerpt_kh) }}</textarea>
            ...
            <div class="mt-6">
                ...
                <textarea id="content_en" name="content_en" rows="8"
                          class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">{{ old('content_en', $news->content_en) }}</textarea>
            ...
            <div class="mt-6">
                ...
                <textarea id="content_kh" name="content_kh" rows="8"
                          class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">{{ old('content_kh', $news->content_kh) }}</textarea>
