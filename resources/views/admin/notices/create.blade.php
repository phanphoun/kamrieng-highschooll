...
@section('content')
    <div class="mb-6">
        ...
        <p class="text-gray-600 mt-1">Add a new school notice or announcement</p>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <textarea name="content_en" id="content_en" rows="5"
                              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500">{{ old('content_en') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="content_kh" id="content_kh" rows="5"
                              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500">{{ old('content_kh') }}</textarea>
