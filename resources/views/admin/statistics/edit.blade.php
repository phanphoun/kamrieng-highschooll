...
@section('content')
    <div class="mb-8">
        ...
        <p class="text-gray-600 mt-1">Update this dashboard statistics counter.</p>
    </div>
        ...
        <form action="{{ route('admin.statistics.update', $statistic) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" id="label_en" name="label_en" value="{{ old('label_en', $statistic->label_en) }}" required
                ...
                <div>
                    ...
                    <input type="text" id="label_kh" name="label_kh" value="{{ old('label_kh', $statistic->label_kh) }}"
                           class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">
                ...
                <div>
                    ...
                    <input type="text" id="value" name="value" value="{{ old('value', $statistic->value) }}" required
                           class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">
                ...
                <div>
                    ...
                    <input type="text" id="icon" name="icon" value="{{ old('icon', $statistic->icon) }}"
                           class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">
                ...
                <div>
                    ...
                    <input type="text" id="prefix" name="prefix" value="{{ old('prefix', $statistic->prefix) }}"
                           class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">
                ...
                <div>
                    ...
                    <input type="text" id="suffix" name="suffix" value="{{ old('suffix', $statistic->suffix) }}"
                           class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">
                ...
                <div>
                    ...
                    <input type="number" id="sort_order" name="sort_order" value="{{ old('sort_order', $statistic->sort_order) }}"
                           class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500">
            ...
            <div class="mt-6">
                <label class="flex items-center gap-2">
                    <input type="checkbox" name="is_active" value="1" {{ old('is_active', $statistic->is_active) ? 'checked' : '' }}
