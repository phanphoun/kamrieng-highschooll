...
@section('title', 'Kamrieng High School')
...
<nav x-data="{ mobileOpen: false, scrolled: false, lang: 'en', langOpen: false }"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
        <div class="flex items-center justify-between h-full">
            ...
            <div class="hidden lg:flex items-center gap-0.5">
                <a href="{{ route('home') }}" class="px-3 xl:px-4 py-2 text-sm font-medium text-white rounded-lg hover:bg-white/10 transition-colors">Home</a>
    ...
    <div x-show="mobileOpen"
        ...
        <div class="px-4 py-4 space-y-1">
            <a href="{{ route('home') }}" class="block px-4 py-2.5 text-white font-semibold bg-white/10 rounded-lg">Home</a>
...
<section class="relative min-h-screen flex items-center bg-header overflow-hidden"
         ...
         x-init="setInterval(() => { activeSlide = (activeSlide + 1) % {{ count($slides) > 0 ? count($slides) : 1 }}; }, 6000)">
    ...
    <div class="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
        <div class="max-w-2xl">
            ...
            <div class="flex flex-wrap gap-3">
                <a href="{{ isset($slides[0]) && $slides[0]->button_link ? $slides[0]->button_link : '#about' }}"
                   class="inline-flex items-center gap-2 px-6 py-3 bg-btn text-white font-semibold rounded-lg hover:bg-btn-hover transition-all shadow-lg shadow-btn/25 hover:shadow-xl text-sm lg:text-base">
                    {{ isset($slides[0]) && $slides[0]->button_text_en ? $slides[0]->button_text_en : 'Learn More' }}
    ...
    <div class="absolute bottom-10 left-1/2 -translate-x-1/2 z-20 flex items-center gap-2.5">
        ...
        <button @click="activeSlide = {{ $index }}"
                ...
                :class="activeSlide === {{ $index }} ? 'bg-accent w-8' : 'bg-white/30 hover:bg-white/60'"
...
<section id="gallery" class="py-16 lg:py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            ...
            <div class="group relative rounded-xl overflow-hidden aspect-square cursor-pointer border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300 {{ $item['class'] ?? '' }}">
...
<footer class="bg-header text-footer-muted">
    ...
    <div class="border-t border-white/10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-2">
            <p class="text-footer-muted/60 text-xs">© {{ date('Y') }} Kamrieng High School. All rights reserved.</p>
