...
@section('title', 'About Us - Kamrieng High School')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10 mb-16 lg:mb-20">
                @forelse($leadershipTeam as $member)
                    ...
                    @endphp
                    <div class="about-card group bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden" data-about-reveal style="--reveal-delay: {{ ($loop->index % 3) * 100 }}ms">
