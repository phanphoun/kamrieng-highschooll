...
@section('title', 'Mission & Vision - Kamrieng High School')
    ...
    <section class="bg-white border-b border-gray-100 sticky top-16 lg:top-20 z-40">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <nav class="flex gap-6 -mb-px overflow-x-auto scrollbar-hide">
                ...
                <a href="{{ route('about.mission-vision') }}" class="shrink-0 py-4 px-1 text-sm font-medium text-blue-700 border-b-2 border-blue-700 whitespace-nowrap">Mission &amp; Vision</a>
                <a href="{{ route('about.leadership') }}" class="shrink-0 py-4 px-1 text-sm font-medium text-gray-500 hover:text-gray-700 border-b-2 border-transparent hover:border-gray-300 whitespace-nowrap transition-colors">Leadership</a>
            </nav>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <a href="{{ route('about.index') }}" class="inline-flex items-center px-6 py-3 bg-blue-700 text-white font-semibold rounded-full hover:bg-blue-800 transition-all">
                        Learn Our History
                    </a>
                    <a href="{{ route('about.leadership') }}" class="inline-flex items-center px-6 py-3 border-2 border-gray-300 text-gray-700 font-semibold rounded-full hover:border-blue-700 hover:text-blue-700 transition-all">
                        Meet Our Leadership
                    </a>
                </div>
            </div>
