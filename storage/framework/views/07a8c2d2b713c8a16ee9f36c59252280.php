    ...
    <header x-data="{ mobileOpen: false }" class="sticky top-0 z-50 bg-[#192436]/95 shadow-[0_10px_30px_-24px_rgba(0,0,0,0.8)] border-b border-white/5 backdrop-blur-xl">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 lg:h-20">
                ...
                <nav class="hidden lg:flex items-center gap-1">
                    <a href="<?php echo e(url('/')); ?>" class="px-4 py-2 text-sm font-medium text-white/75 hover:text-[#f7b316] rounded-lg hover:bg-white/5 transition-all">Home</a>
                    <a href="<?php echo e(route('about.index')); ?>" class="relative px-4 py-2 text-sm font-semibold text-[#f7b316] rounded-lg after:absolute after:left-1/2 after:-bottom-1 after:h-1 after:w-1 after:-translate-x-1/2 after:rounded-full after:bg-[#f7b316]">About School</a>
        ...
        <div x-show="mobileOpen" x-cloak @click.outside="mobileOpen = false" class="lg:hidden border-t border-white/10 bg-[#192436]/98 backdrop-blur-xl">
            <div class="max-w-7xl mx-auto px-4 py-3 space-y-1">
                <a href="<?php echo e(url('/')); ?>" class="block px-3 py-2 text-sm font-medium text-white/75 hover:text-[#f7b316] hover:bg-white/5 rounded-lg">Home</a>
                <a href="<?php echo e(route('about.index')); ?>" class="block px-3 py-2 text-sm font-semibold text-[#f7b316] bg-white/5 rounded-lg">About School</a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                ...
                <div>
                    ...
                    <ul class="space-y-2.5">
                        <li><a href="<?php echo e(route('about.index')); ?>" class="text-sm text-[#9ca6b4] hover:text-white transition-colors">About School</a></li>
                        <li><a href="<?php echo e(route('about.leadership')); ?>" class="text-sm text-[#9ca6b4] hover:text-white transition-colors">Leadership</a></li>
...
<?php /**PATH /Users/macbook/Desktop/kamrieng-highschooll/resources/views/layouts/public.blade.php ENDPATH**/ ?>